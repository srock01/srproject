...
import { getFirestore,Timestamp, doc, getDoc, setDoc, addDoc, updateDoc,arrayUnion,onSnapshot } from "firebase/firestore";
...
export default function LeagueCreate({route, navigation}) {
  ...
  async function registerPress() {
    ...
    try {
        ...
        { name:name,locations:location,url:cuh,owner:email, minPlayer:player,maxPlayer:playerMax,maxTeam:teams,currentTeams:0,sport:sport, startDate:Timestamp.fromDate(dateS), endDate:dateE,rsDate:dateRS, reDate:dateRE });
        console.log("clothing article added");
        const washingtonRef = doc(db, "organization", org);

        // Atomically add a new region to the "regions" array field.
        await updateDoc(washingtonRef, {
           leagues: arrayUnion(name)
        });
        navigation.navigate('Manage Organization',{name:"Manage "+org});
    } catch (e) {
  ...
  return (
    ...
    keyboardShouldPersistTaps='handled'>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputView}>
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center',paddingTop:15}}>
            <View style={{backgroundColor:'white',borderRadius:30}}><Button style={{paddingBottom:35}} title="Pick a League Picture" onPress={pickImage} /></View>
      ...
      <ScrollView style={{height:0,width:'80%',flexDirection:"column", backgroundColor:"white",borderRadius:6}}>
        <View style={{ backgroundColor:"white",  }}>
        {location[0]===undefined?
          <View style={{alignItems:"center",paddingTop:35}}>
            <Text style={styles.buttonTxt}>SELECT LOCATIONS BELOW</Text>
      ...
      />
        ...
        <View style={styles.inputView2}>
            ...
            keyboardType="numeric"
            style={styles.TextInput2}
            placeholder="MIN NUMBER OF PLAYER PER TEAM"
            placeholderTextColor="#007AFF"
        ...
        <View style={styles.inputView2}>
            ...
            keyboardType="numeric"
            style={styles.TextInput2}
            placeholder="MAX NUMBER OF PLAYER PER TEAM"
            placeholderTextColor="#007AFF"
            onChangeText={(playerMax) => setMaxPlayer(parseInt(playerMax))}
          />
        </View>
        <View style={styles.inputDate}>
        <Text style={styles.buttonTxt2}>SEASON BEGINS:</Text>
          <DateTimePicker
      ...
      <View style={styles.inputDate}>
        <Text style={styles.buttonTxt2}>SEASON ENDS:</Text>
          <DateTimePicker
          testID="dateTimePicker"
          value={dateE}
          mode={"date"}
      ...
      <View style={styles.inputView3}>
        <Text style={styles.buttonTxt2}>REGISTRATION STARTS:</Text>
          <DateTimePicker
          testID="dateTimePicker"
          value={dateRS}
          mode={"datetime"}
      ...
      <View style={styles.inputView3}>
        <Text style={styles.buttonTxt2}>REGISTRATION CLOSES:</Text>
          <DateTimePicker
          testID="dateTimePicker"
          value={dateRE}
          mode={"datetime"}
